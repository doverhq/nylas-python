...
VERSION = ""
with open("dover_nylas/_client_sdk_version.py", "r") as fd:
    VERSION = re.search(
...
def main():
    ...
    # by running: pip install dover_nylas['release']
    if len(sys.argv) > 1:
        if sys.argv[1] == "publish":
            ...
            try:
                ...
                print(
                    "Error encountered: {}.\n\n".format(e),
                    "Did you install the extra 'release' dependencies? (pip install dover_nylas['release'])",
                )
            sys.exit()
